...
product_category = Label(text="Category", bg='#D9D9D9',
...
Button(root, text='Edit', bg='#FF702A', fg='white', width=6, border=1,
       font=("Poppins", 15), command=update).place(x=950, y=80, height=37)
# schrolbar
...
medicinearea = Text(medicineListframe, yscrollcommand=scrolly.set,
                    font=("Poppins", 13), fg='black')
