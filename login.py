...
def forget():
    ...
    def on_leave(e):
        ...
        # return name
    # username
    username1 = Entry(top, fg='black', bg='#FAFAFA', border=1, font=(
    ...
    # /password workspace
    new_password = Entry(top, width=40, fg='black', bg='#FAFAFA', border=1, font=(
        'microsoft yaHei UI light', 15), cursor='hand2', show='*')
    ...
    eyebutton = Button(top, image=eyeimg, bd=0, bg='white',
    ...
    # /password workspace
    confirm_password = Entry(top, width=40, fg='black', bg='#FAFAFA', border=1, font=(
        'microsoft yaHei UI light', 15), cursor='hand2', show='*')
    ...
    save = Button(top, text='SAVE', width=10, bg='green', fg='white', font=(
        "microsoft yaHei UI light", 12), cursor='hand2', command=save)
...
Label(text='Developed By : Let It Be', bg='#FF702A', fg='white',
      font=('poppins', 12, 'bold')).place(x=840, y=550)
Label(text='X', font=('Dancing Script', 14, 'bold'),
      bg='#FF702A', fg='white').place(x=1030, y=548)
...
# heading
heading = Label(frame, text='SIGN IN', fg='#FF702A', bg='white',
                font=('microsoft yaHei UI light', 20, 'bold'))
heading.place(x=150, y=28)
heading = Label(frame, text='sign in & get started', fg='#6B6B6B',
                bg='white', font=('microsoft yaHei UI light', 20))
...
# username workspace
username = Entry(frame, width=35, fg='#6B6B6B', border=1, bg='white', font=(
    'microsoft yaHei UI light', 17), cursor='hand2')
...
# /password workspace
code = Entry(frame, width=35, fg='#6B6B6B', border=1, bg='white', font=(
    'microsoft yaHei UI light', 17), cursor='hand2', show='*')
...
forgotbutton = Button(root, text="Forgot Password?", bd=0, bg='white', activebackground='white',
                      cursor='hand2', font=('microsoft yaHei UI light', 12, 'bold'), command=forget)
forgotbutton.place(x=434, y=340)
# sign in button
Button(frame, width=30, pady=10, text='Sign In', bg='#FF702A', fg='white', border=0,
       command=signin, font=('Inter', 10, 'bold'), cursor='hand2').place(x=130, y=320)
# remember me button
checkbox = ctk.CTkCheckBox(root, text='Remember Me')
checkbox.place(x=120, y=350)
# footer
copyright = "\u00A9"
l1 = Label(root, text=copyright, bg='white',
           fg='#6B6B6B', font=('poppins', 16, 'bold'))
l1.place(x=200, y=550)
l2 = Label(root, text='2023 copyright| Pharmacy Store',
           bg='white', fg='#6B6B6B', font=('poppins', 13, 'bold'))
