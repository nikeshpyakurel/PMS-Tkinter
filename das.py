...
appo = Label(root, text='Latest Products', bg='#D2C8C8',
             fg='black', font=("inter", 15, "bold"))
...
product_name = Label(text="Product Name", bg='#FF702A',
                     font=("poppins", 12, "bold"))
product_name.place(x=370, y=328)
product_status = Label(text="Product Status", bg='#FF702A',
                       font=("poppins", 12, "bold"))
product_status.place(x=620, y=328)
product_quantity = Label(text=" Quantity", bg='#FF702A',
                         font=("poppins", 12, "bold"))
...
for i in a:
    ...
    for j in range(1, len(b)+1):
        Label(frame3, text=b[0], bg='#FAFAFA',
              font=("poppins", 10)).place(x=40, y=d)
        d = d+30
        Label(frame3, text=b[1], bg='#FAFAFA',
              font=("poppins", 10)).place(x=180, y=c)
        c = c+30
        Label(frame3, text=b[3], bg='#FAFAFA',
              font=("poppins", 10)).place(x=910, y=e)
        e = e+30
        Label(frame3, text=b[4], bg='#FAFAFA',
              font=("poppins", 10)).place(x=700, y=f)
        f = f+30
        if b[4] > 0:
            Label(frame3, text='in stock', bg='#FF702A', borderwidth=3,
                  fg='black', font=("poppins", 10)).place(x=440, y=g)

            g = g+30
        else:
            Label(frame3, text='out of stock', bg='red', fg='black',
                  font=("poppins", 10)).place(x=440, y=g)
            g = g+30
        break
root.mainloop()
