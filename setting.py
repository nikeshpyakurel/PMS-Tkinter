...
# /password workspace
new_password = Entry(root, width=40, fg='black', bg='#FAFAFA', border=1, font=(
...
# /password workspace
confirm_password = Entry(root, width=40, fg='black', bg='#FAFAFA', border=1, font=(
    'microsoft yaHei UI light', 15), cursor='hand2', show='*')
...
eyebutton2 = Button(root, image=eyeimg2, bd=0, bg='white',
                    activebackground='white', cursor='hand2', command=show1)
eyebutton2.place(x=855, y=410)

save = Button(root, text='SAVE', width=10, bg='green', fg='white', font=(
